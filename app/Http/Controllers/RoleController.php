...
class RoleController extends Controller
{
    ...
    {
        $data = RoleModel::all();
        return view('RoleView', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('RoleViewEdit', compact ('data'));
    }
    ...
    public function destroy($id)
    {
        $data = RoleModel::where('id',$id)->first();
        $data->delete();
        return redirect()->route('role.index')->with('alert-success','Data berhasi dihapus!');
    }
}
